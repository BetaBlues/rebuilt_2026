...
public class RobotContainer {
    ...
    private final Motor m_Motor = Constants.hasMotor ? new Motor("Motor Test", 4, Constants.SpinMotorConstants.pos_kP, Constants.SpinMotorConstants.pos_kI, Constants.SpinMotorConstants.pos_kD) : null;
    ...
    private final Motor m_Intake = Constants.hasIntake ? new Motor("Intake", 9, Constants.IntakeConstants.pos_kP, Constants.IntakeConstants.pos_kI, Constants.IntakeConstants.pos_kD) : null;
    private final Climber m_Climber = Constants.hasClimber ? new Climber("Climber", 7, Constants.ClimberConstants.absPort, Constants.ClimberConstants.pos_kP, Constants.ClimberConstants.pos_kI, Constants.ClimberConstants.pos_kD) : null;
